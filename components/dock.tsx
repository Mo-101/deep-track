...
function DockLabel({ children, className = "", isHovered }: DockLabelProps) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error("Error with isHovered subscription:", error)
    }
  }, [isHovered])
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: "none" }} className="mx-2 flex max-w-full items-center">
      <motion.div
        ...
        className={`${className} absolute bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4 bg-black/80 backdrop-blur-md shadow-[0_0_15px_rgba(0,255,255,0.2)]`}
